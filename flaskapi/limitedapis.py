...
def fast():
    return "I override default by adding the limiter decorator. By removing we can use the defaults set of 200 per day / 50 per hour"
...
@app.route("/name")
def name():
    return abort(404, "Nothing to see here.")
